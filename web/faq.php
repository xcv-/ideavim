...
<dd>
Select the <code>Tools</code> menu and make sure the menu <code>VIM Emulator</code> has a checkmark next to it.
</dd>
<dt>
<a name="turnoff"></a>
How do I turn off the VIM plugin once it is installed?
...
<code>VIM Emulator</code> menu.
Reverse this process to turn the VIM emulator back on. These settings will be saved
