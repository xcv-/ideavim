...
import com.maddyhome.idea.vim.handler.motion.scroll.MotionScrollFirstScreenColumnHandler;
...
public class MotionScrollFirstScreenColumnAction extends EditorAction
{
    ...
    {
        super(new MotionScrollFirstScreenColumnHandler());
    }
}
