...
public class EditorHelper
{
    ...
    */
    ...
    {
        if (editor.getDocument().isWritable())                       // API change - don't merge
        {                                                            // API change - don't merge
            return true;                                             // API change - don't merge
        }                                                            // API change - don't merge
        else                                                         // API change - don't merge
        {                                                            // API change - don't merge
            editor.getDocument().fireReadOnlyModificationAttempt();  // API change - don't merge
